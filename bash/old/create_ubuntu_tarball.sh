#!/bin/bash
#
# create_ubuntu_tarball.sh
# - generates an Ubuntu tarball from within ChromeOS
# - asks user to upload it to Dropbox etc.
# - terminates
#
# To run, type:-
# cd && wget bit.ly/1lBwN9E -O xx && sudo bash xx
#################################################################################
#
...
failed "THIS UBUNTU TARBALL GENERATOR HASN'T BEEN WRITTEN YET"
exit 0
