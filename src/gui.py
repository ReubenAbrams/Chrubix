...
class MainWindow( QtGui.QMainWindow, Ui_mnwMain ):
    '''Main GUI for the Chrubix distro self-configurator.
    '''
...
class ReconfigureorexitDialog( QtGui.QDialog, Ui_dlgReconfigureorexit ):
    '''If changes were made to the configuration of the Chrubix distro installed, we must apply those changes.
    '''
    def __init__( self ):
